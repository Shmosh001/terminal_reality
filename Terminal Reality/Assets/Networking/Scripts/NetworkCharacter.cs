...
public class NetworkCharacter : Photon.MonoBehaviour {
    ...
    public float lerpSmoothing = 1.0f;
    ...
    /// <summary>
    /// gets called by photon and syncs data
    /// </summary>
    /// <param name="stream">
    /// stream of data
    /// </param>
	...
	public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info){
		...
		//if (init){
			...
			if (stream.isWriting){
                ...
                //sends the speed so that the animator gets updated with this value
            }
			else{
