...
public class sectionOne : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (playerData.inSectionOne == true && enemyInRoom == 0)
		{
			soundController.GetComponent<soundControllerScript>().playSafeBackgroundSound();
		}
		else if (playerData.inSectionOne == true && enemyInRoom > 0)
		{
