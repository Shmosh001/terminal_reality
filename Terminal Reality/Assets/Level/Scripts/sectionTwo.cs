...
public class sectionTwo : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (playerData.inSectionTwo == true && enemyInRoom == 0)
		{
			soundController.GetComponent<soundControllerScript>().playSafeBackgroundSound();
		}
		else if (playerData.inSectionTwo == true && enemyInRoom > 0)
		{
